...
export function buildAdminNavActions(t: TFunction): AdminNavAction[] {
  return [
    ...
    { title: 'Academic Planner', icon: 'map-outline', route: '/admin/academic-planner', tier: 'PRIMARY', gradient: ['#312E81', '#6366F1'], category: 'Academic', permission: 'academic_planner.view' },
    { title: 'Academic Calendar', icon: 'calendar-outline', route: '/admin/calendar', tier: 'PRIMARY', gradient: ['#4338CA', '#3B82F6'], category: 'Academic' },
    { title: 'Event Operations', icon: 'trophy-outline', route: '/admin/events', tier: 'PRIMARY', gradient: ['#4F46E5', '#06B6D4'], category: 'Ops' },
    ...
    { title: 'UDISE Readiness', icon: 'shield-checkmark-outline', route: '/admin/udise-readiness', tier: 'ADMIN', gradient: ['#1E3A8A', '#0284C7'], category: 'Compliance', permission: 'udise.view' },
    ...
    { title: 'Subscription', icon: 'card-outline', route: '/admin/subscription', tier: 'FINANCE', gradient: ['#0F766E', '#2563EB'], category: 'Finance' },
    ...
    { title: 'Question Papers', icon: 'document-attach-outline', route: '/admin/question-papers', tier: 'ACADEMIC', gradient: ['#4338CA', '#3B82F6'], category: 'Academic' },
    { title: 'Syllabus Tracker', icon: 'list-circle-outline', route: '/admin/syllabus', tier: 'ACADEMIC', gradient: ['#1E3A8A', '#0D9488'], category: 'Academic' },
    { title: 'Approvals Inbox', icon: 'checkbox-outline', route: '/admin/approvals', tier: 'ADMIN', gradient: ['#92400E', '#F59E0B'], category: 'Governance', permission: 'admin.manage' },
    { title: 'Audit Explorer', icon: 'shield-outline', route: '/admin/audit-explorer', tier: 'ADMIN', gradient: ['#0F172A', '#334155'], category: 'Governance', permission: 'admin.manage' },
    { title: 'Document Alerts', icon: 'alert-circle-outline', route: '/admin/document-alerts', tier: 'ADMIN', gradient: ['#991B1B', '#EA580C'], category: 'Governance', permission: 'students.view' },
