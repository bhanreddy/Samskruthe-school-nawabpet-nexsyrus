...
export default function AccountsDashboard() {
  ...
  const quickActions = useMemo(() => [
    ...
    { id: 'exams', title: 'Exams', description: 'Timetables, hall tickets and results', icon: 'clipboard-outline', color: ['#3730A3', '#0EA5E9'] as [string, string], route: '/accounts/exams', library: Ionicons },
